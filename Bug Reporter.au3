...
#AutoIt3Wrapper_Icon=lib\DebugTools\virus.ico
...
Global $tempFolder = @ScriptDir & "\lib\Temp_Debug\"
Global $userMessage = $tempFolder & "\Report_Message.txt"
Global $p7zip = @ScriptDir & "\lib\DebugTools\7za.exe"
Global $pcURL = @ScriptDir & "\lib\curl\curl.exe"
Global $pcURL_log = @ScriptDir & "\lib\curl\cURL_report.txt"
Global $pData = @ScriptDir & "\Debug_data.7z"
...
Func Screen4()
	...
	While 1
		...
		Switch $NMSG
			...
			Case $btnFinish
				GUIDelete($Step4)
				ShellExecute("https://mybot.run/forums/index.php?/topic/27787-mybot-653-octopus-doc_2614-multifinger-multifarm-deb-csv-speed/")
				Exit
		EndSwitch
	WEnd
